...
export function InputAdd({ onSubmit }: InputAddProps) {
  ...
  return (
    ...
    >
      ...
      <footer>
        <button
          className="bg-product-bluedark text-base-gray-100 flex items-center p-4 ml-2 rounded-lg focus:outline-none"
          type="submit"
